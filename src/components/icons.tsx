...
/* Minimal inline icon set (stroke style, lucide-compatible geometry) */
...
export function Send(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
      <path d="M14.5 9.5 21 3m0 0-6.8 18a.5.5 0 0 1-.94.03L10 13l-7.97-3.26a.5.5 0 0 1 .03-.94L21 3Z" />
    </svg>
  );
}
