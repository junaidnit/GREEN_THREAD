  ...
  return (
    <div className="mx-auto max-w-[1000px] px-6 py-20 sm:px-10">
      <div className="text-center">
        ...
        <h1 className="mx-auto mt-3 max-w-[18ch] font-display text-[clamp(2rem,4.6vw,2.5rem)] leading-tight text-foreground">
      ...
      <div className="mt-20 border-t border-border pt-16">
        <h2 className="text-center font-display text-[28px] text-foreground">Installing it</h2>
        <div className="mt-10 grid gap-8 md:grid-cols-3">
          {INSTALL.map(([h, p], i) => (
            <div key={h}>
              <p className="font-display text-[clamp(2rem,4.6vw,2.5rem)] font-light text-primary/40">{String(i + 1).padStart(2, "0")}</p>
              <h3 className="mt-2 font-display text-[20px] text-foreground">{h}</h3>
              <p className="mt-2 text-[16px] font-light leading-relaxed text-muted-foreground">{p}</p>
            </div>
          ))}
        </div>
        <p className="mx-auto mt-10 max-w-[60ch] text-center text-[14px] font-light leading-relaxed text-muted-foreground">
      ...
      <div className="mt-16 grid gap-8 border-t border-border pt-16 md:grid-cols-3">
        {[
          ...
          <div key={h}>
            <h3 className="font-display text-[20px] text-foreground">{h}</h3>
            <p className="mt-2 text-[16px] font-light leading-relaxed text-muted-foreground">{p}</p>
          </div>
        ))}
      </div>
