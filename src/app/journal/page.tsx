    ...
    <div className="mx-auto max-w-[1280px] px-6 py-16 sm:px-10">
      ...
      <Link href={lead.href} className="group grid gap-8 border-b border-border pb-14 md:grid-cols-2">
        <div className="relative aspect-[4/3] overflow-hidden bg-surface-2">
          {img(lead.m) && <Image src={img(lead.m)!} alt={lead.title} fill sizes="(max-width:768px) 100vw, 50vw" priority className="object-cover transition-transform duration-700 group-hover:scale-105" />}
        </div>
      ...
      <div className="mt-14 grid gap-x-8 gap-y-12 sm:grid-cols-2 lg:grid-cols-3">
        {rest.map((a) => (
          <Link key={a.href} href={a.href} className="group">
            <div className="relative aspect-[4/3] overflow-hidden bg-surface-2">
              {img(a.m) && <Image src={img(a.m)!} alt={a.title} fill sizes="(max-width:768px) 100vw, 33vw" className="object-cover transition-transform duration-700 group-hover:scale-105" />}
            </div>
